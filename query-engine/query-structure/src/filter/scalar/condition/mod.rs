...
pub enum ScalarCondition {
    ...
    GeometryWithin(ConditionValue),
    GeometryNotWithin(ConditionValue),
    GeometryDWithin(ConditionValue),
    GeometryNotDWithin(ConditionValue),
    GeometryIntersects(ConditionValue),
    GeometryNotIntersects(ConditionValue),
...
impl ScalarCondition {
    pub fn invert(self, condition: bool) -> Self {
        if condition {
            match self {
                ...
                Self::GeometryWithin(v) => Self::GeometryNotWithin(v),
                Self::GeometryNotWithin(v) => Self::GeometryWithin(v),
                Self::GeometryDWithin(v) => Self::GeometryNotDWithin(v),
                Self::GeometryNotDWithin(v) => Self::GeometryDWithin(v),
                Self::GeometryIntersects(v) => Self::GeometryNotIntersects(v),
                Self::GeometryNotIntersects(v) => Self::GeometryIntersects(v),
    ...
    pub fn as_field_ref(&self) -> Option<&ScalarFieldRef> {
        match self {
            ...
            ScalarCondition::GeometryWithin(v) => v.as_field_ref(),
            ScalarCondition::GeometryNotWithin(v) => v.as_field_ref(),
            ScalarCondition::GeometryDWithin(v) => v.as_field_ref(),
            ScalarCondition::GeometryNotDWithin(v) => v.as_field_ref(),
            ScalarCondition::GeometryIntersects(v) => v.as_field_ref(),
            ScalarCondition::GeometryNotIntersects(v) => v.as_field_ref(),
